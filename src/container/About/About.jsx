...
const About = () => {
  return (
    <Box>
      <Banner />
      <Wrapper>
        <Typography variant="h3">Brajesh Singh</Typography>
        <Text variant="h5">
          ...
          <Box component="span" style={{ marginLeft: 5 }}>
            <Link
              href="https://github.com/thakurbrajeshsingh"
              color="inherit"
              target="_blank"
            >
              <GitHub />
        ...
        <Text variant="h5">
          ...
          <Box component="span" style={{ marginLeft: 5 }}>
            <Link href="https://brajesh.tech/" color="inherit" target="_blank">
              <Language />
            </Link>
          </Box>
          or send me an Email
          <Link
            href="mailto:brajeshsingh8210@gmail.com?Subject=This is a subject"
            target="_blank"
            color="inherit"
          >
            <Email />
